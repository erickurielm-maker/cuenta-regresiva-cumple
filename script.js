// Fecha objetivo: 10 de septiembre del año actual
const hoy = new Date();
let añoObjetivo = hoy.getFullYear();
const fechaCumple = new Date(añoObjetivo, 8, 10); // Mes 8 = Septiembre

// Si ya pasó el 10 de septiembre de este año, usamos el próximo año
if (hoy > fechaCumple) {
